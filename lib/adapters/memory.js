    ...
    return {
        ...
        find: function(model, query, cb, one) {
            ...
            for(var uuid in memoryStore) {
                ...
                // Compare properties
                function compareProperties(query, model) {
                    for(var key in query) {
                        if(query[key].constructor == Object || query[key].constructor == Array) {
                            compareProperties(query[key], model[key]);
                        } else {
                ...
                compareProperties(query, modelData);
